...
public class InkBlot {
    ...
    public void generateInkBlot() {
       ...
       RandomWalk x = new RandomWalk(150,0,255);
       RandomWalk y = new RandomWalk(150,0,255);
       RandomWalk red = new RandomWalk(150,0,255);
       RandomWalk blue = new RandomWalk(150,0,255);
       RandomWalk green = new RandomWalk(150,0,255);
       Color col;
        Line line1;
        Line line2;

        for (int i = 0; i<=15000;i++) {
            col = getColor(red,green,blue);
            line1 = advance(x, y);
            line1.setStrokeColor(col);
            line2 = mirror(line1);
            canvas.add(line1);
            canvas.add(line2);
        }
